    ...
    <div className="info-page">
      ...
      <section className="info-page__grid">
        <article className="info-card">
          ...
          <p>
            Start with a clear vision: the occasion, your target audience, and
            the atmosphere you want to create. A strong concept guides every
        ...
        <article className="info-card">
          <h2>Set a budget</h2>
          <p>
            Outline your expected costs early — venue, catering, equipment,
            promotion, and contingency. Tracking spending from day one keeps
        ...
        <article className="info-card">
          ...
          <p>
            ...
            parking, audio-visual capabilities, and whether the location fits
            your event's tone.
          </p>
        </article>
        <article className="info-card">
          ...
          <p>
            ...
            promotions, confirmations, and rehearsals so nothing gets left to
            the last minute.
          </p>
        </article>
        <article className="info-card">
        ...
        <article className="info-card">
          ...
          <p>
            Arrive early, confirm vendor arrivals, test equipment, and brief
            your team. Having a printed run-of-show keeps everyone on the same
            page when things get busy.
          </p>
        </article>
      </section>
    </div>
