...
const faqs = [
  ...
  },
  {
    ...
    a: 'If you notice an error in an event listing, use the Contact Support page to report it. We will review and follow up with the host directly.',
  },
]
  ...
  return (
    <div className="info-page">
      <section className="info-page__hero info-page__hero--centered">
        ...
        <h1>Help Center</h1>
        <p>
          Answers to the most common questions about using Eventcinity - from creating
          events to managing your profile.
        </p>
      </section>
